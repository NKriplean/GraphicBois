...
window.onload = function init(){
	...
	maze = new Maze (program, ARENASIZE/3, 0.0, 0.0, 0, 10.0);
	maze.init();
...
window.onkeydown = function(event) {
	...
	onkeydown = onkeyup = function(e){
		...
		if(map[87] && map[37]){ //Villain movement & Hero Forward
			hero.move(speed);
			villain.turn(-speed);
			...
			hero.move(speed);
			villain.move(-speed);
		}else if(map[83] && map[37]){ //Villain movement & Hero Backward
			hero.move(-speed);
			villain.turn(-speed);
			...
			hero.move(-speed);
			villain.move(-speed);
		} else if(map[68] && map[37]){ //Villain movement & Hero Right
			hero.turn(speed);
			villain.turn(-speed);
			...
			hero.turn(speed);
			villain.move(-speed);
		}else if(map[65] && map[37]){ //Villain movement & Hero Left
			hero.turn(-speed);
			villain.turn(-speed);
