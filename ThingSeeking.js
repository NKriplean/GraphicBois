...
function ThingSeeking(program, x, y, z, degrees, bounding_cir_rad)  {
    ...
    this.thingSeekingVertices = diamondMesh.vertices[0].values;

    this.thingSeekingNormals = diamondMesh.vertices[1].values;

    this.thingSeekingIndices = diamondMesh.connectivity[0].indices;
...
ThingSeeking.prototype.show = function() {
    ...
    modelViewMatrix = mult(modelViewMatrix, scalem(15,15,15));
